...
## ❀ Visual Reference: Open Challenge Logic ────୨ৎ────────୨ৎ────

<p align="center">
  <img src="../../img/Flowchart_logic_cheese.png" alt="Cheese Open Challenge logic flowchart" width="90%">
</p>

<p align="center">
  <em>Flowchart showing Cheese’s Open Challenge logic: initialization, wall sensing, PID centering, protected wall correction, color-confirmed curve tracking, lap counting, and final stopping behavior.</em>
</p>

The flowchart shows that Cheese’s Open Challenge logic is not a single straight-line process. It is a loop that constantly checks sensors and decides which behavior should control the robot. Normal PID driving is used when the robot is stable, wall protection takes priority when the robot gets too close to a wall, and color detection updates the curve and lap counters.
