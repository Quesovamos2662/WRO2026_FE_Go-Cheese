...
<p align="center">
  ...
  <em>Left: Technic liftarms used as the main structural members of the chassis. Right: pins and axles used to connect the structure and transfer motion through the robot.</em>
</p>

<p align="center">
  <img src="../../img/broken_pin.jpeg" alt="Broken Technic Pin" width="45%"><br>
  <em>Example of a broken Technic pin, showing one of the real physical limitations we encountered during repeated testing and rebuilding.</em>
</p>
